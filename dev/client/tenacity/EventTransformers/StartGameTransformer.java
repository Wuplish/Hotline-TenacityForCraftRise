package dev.client.tenacity.EventTransformers;
...
public class StartGameTransformer {
            ...
            public MethodVisitor visitMethod(int access, String name, String descriptor, String signature, String[] exceptions) {
                ...
                if (name.equals("D") && descriptor.equals("(J)V"))
                {
                    return new MethodVisitor(Opcodes.ASM9, original_mv) {
                        ...
                        {
                            mv.visitMethodInsn(Opcodes.INVOKESTATIC, "dev/client/tenacity/Tenacity", "TenacityStart", "()V", false);
                            mv.visitCode();

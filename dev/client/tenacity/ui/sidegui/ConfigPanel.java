...
import com.craftrise.client.eQ;
...
public class ConfigPanel extends GuiPanel
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks, int alpha)
    {
        ...
        eQ dynamicTexture = null;

        try
        {
            BufferedImage image = ImageIO.read(new File("C:\\Tenacity\\configbackground.png"));
            dynamicTexture = new eQ(image);
            //resourceLocation = mc.getTextureManager().a("tenacity/configbackground", dynamicTexture);

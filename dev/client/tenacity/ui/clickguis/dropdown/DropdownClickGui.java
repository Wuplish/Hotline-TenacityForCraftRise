...
public class DropdownClickGui extends dG
{
    ...
    @Override
    protected void a(char c3, int n2)
    {
        if (n2 == 1)
        {
        ...
        Tenacity.INSTANCE.getSideGui().keyTyped(c3, n2);
        categoryPanels.forEach(categoryPanel -> categoryPanel.keyTyped(c3, n2));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        boolean hoveringConfig = HoveringUtil.isHovering(u - 120, A - 65, 75, 25, fakeMouseX, fakeMouseY);

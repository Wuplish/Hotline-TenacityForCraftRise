...
public class Radar extends Module {
    ...
    private final List<com.craftrise.mj> entities = new ArrayList<>();
    ...
    private final EventListener<Render2DEvent> render2DEvent = e -> {
        ...
        GLUtil.rotate(middleX, middleY, cr.launcher.main.a.q.bL, () -> {
            for (com.craftrise.mj entity : entities) {
                double xDiff = MathUtils.interpolate(entity.a4, entity.bE, getTimer().a.a()) - MathUtils.interpolate(cr.launcher.main.a.q.a4, cr.launcher.main.a.q.bE, getTimer().a.a());
                double zDiff = MathUtils.interpolate(entity.at, entity.bH, getTimer().a.a()) - MathUtils.interpolate(cr.launcher.main.a.q.at, cr.launcher.main.a.q.bH, getTimer().a.a());
    ...
    public void getEntities() {
        ...
        for (com.craftrise.m9 entity :Config.getMinecraft().bu.g) {
            if (entity instanceof com.craftrise.mj) {
                if (entity instanceof com.craftrise.mg && entity != cr.launcher.main.a.q) {
                    entities.add((com.craftrise.mj) entity);
                }
            }
        }
    }

...
public class RoundedUtil
{
    ...
    public static ShaderUtil roundedOutlineShader = new ShaderUtil("C:\\Tenacity\\Shaders\\roundRectOutline.frag");
    private static final ShaderUtil roundedTexturedShader = new ShaderUtil("C:\\Tenacity\\Shaders\\roundRectTextured.frag");
    ...
    private static void setupRoundedRectUniforms(float x, float y, float width, float height, float radius, ShaderUtil roundedTexturedShader)
    {
        ...
        roundedTexturedShader.setUniformf("location", x * sr.getScaleFactor(),
                                          (sr.getScaledHeight() - (height * sr.getScaleFactor())) - (y * sr.getScaleFactor()));

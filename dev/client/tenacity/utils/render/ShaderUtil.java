...
import dev.utils.misc.FileUtils;
...
public class ShaderUtil implements Utils
{
    ...
    public ShaderUtil(String fragmentShaderLoc, String vertexShaderLoc)
    {
        ...
        try
        {
            ...
            switch (fragmentShaderLoc)
            {
                ...
                default:
                    fragmentShaderID = createShader(FileUtils.getInputStream(fragmentShaderLoc), GL_FRAGMENT_SHADER);
                    break;
            }

            glAttachShader(program, fragmentShaderID);
            int vertexShaderID = createShader(FileUtils.getInputStream(vertexShaderLoc), GL_VERTEX_SHADER);
    ...
    {
        this(fragmentShaderLoc, "C:\\Tenacity\\Shaders\\vertex.vsh");
    }

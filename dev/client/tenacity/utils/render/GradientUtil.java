...
{
    private static final ShaderUtil gradientMaskShader = new ShaderUtil("C:\\Tenacity\\Shaders\\gradientMask.frag");
    private static final ShaderUtil gradientShader = new ShaderUtil("C:\\Tenacity\\Shaders\\gradient.frag");
    ...
    public static void drawGradient(float x, float y, float width, float height, float alpha, Color bottomLeft, Color topLeft, Color bottomRight, Color topRight)
    {
        ...
        gradientShader.init();
        gradientShader.setUniformf("location", x * sr.getScaleFactor(), (sr.getScaledHeight() - (height * sr.getScaleFactor())) - (y * sr.getScaleFactor()));
    ...
    public static void applyGradient(float x, float y, float width, float height, float alpha, Color bottomLeft, Color topLeft, Color bottomRight, Color topRight, Runnable content)
    {
        ...
        ScaledResolution sr = new ScaledResolution(mc);
        gradientMaskShader.setUniformf("location", x * sr.getScaleFactor(), (sr.getScaledHeight() - (height * sr.getScaleFactor())) - (y * sr.getScaleFactor()));

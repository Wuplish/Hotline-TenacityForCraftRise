...
import com.craftrise.client.dl;
import net.minecraft.client.gui.GuiScreen;
import net.minecraft.client.renderer.GlStateManager;
import net.minecraft.client.renderer.Tessellator;
import net.minecraft.client.renderer.WorldRenderer;
import net.minecraft.client.renderer.vertex.DefaultVertexFormats;
import cr.launcher.ChatAllowedCharacters;
...
public class PasswordField extends Gui
{
    ...
    private dl.a field_175210_x;
    private Predicate<String> field_175209_y = s -> true;

    public PasswordField(String placeholder, int componentId, int x, int y, int par5Width, int par6Height, MinecraftFontRenderer fr)
    {
    ...
    public PasswordField(String placeholder, int componentId, int x, int y, int par5Width, int par6Height, MinecraftFontRenderer fr, int textColor)
    {
        this.placeholder = placeholder;
        this.id = componentId;
        this.xPosition = x;
    ...
    public void func_175207_a(dl.a p_175207_1_)
    {
